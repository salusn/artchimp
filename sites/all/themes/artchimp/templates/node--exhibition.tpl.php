...
<div id="node-<?php print $node->nid;?>" class="<?php print $classes;?> clearfix"<?php print $attributes;?>>
  <div class="content"<?php print $content_attributes;?>>
    <div class="blog-post">
      ...
      <div class="lh-solid mt3 mb5">
        <?php print render($title_prefix);?>
        <?php if (!$page): ?>
          <div class="ttu b black-60">Hardcoded Location</div>
          <div class="f2 b black-80 mt2 mb3">
        ...
        <?php
          ...
          echo "<div>" . formatted_date_range($start_date, $end_date) . "</div>";
        ?>
      </div>
        <?php if ($page): ?>
          <div>
